...
#include <AutoItConstants.au3>                               ; added:09/06/24 07:17:48
#include <ExtMsgBox.au3>                                     ; added:09/06/24 07:17:48
#include <File.au3>                                          ; added:09/06/24 07:17:48
...
#AutoIt3Wrapper_Res_Fileversion=130.0.1.0
#AutoIt3Wrapper_Res_ProductVersion=130.0.1
...
If $Firefox7z Then FileInstall(".\embed\Firefox.7z", @ProgramFilesDir & "\SandboxYourFox\Firefox.7z")
...
Func ExtractFiles()
RunWait(@ComSpec & " /c " & '7z.exe x Firefox.7z', @ProgramFilesDir & "\SandboxYourFox", @SW_HIDE)
EndFunc
...
Func Cleanup()
Local $iDelete1 = FileDelete(@ProgramFilesDir & "\SandboxYourFox\Firefox.7z")
...
Local $iDelete5 = FileDelete(@ProgramFilesDir & "\SandboxYourFox\Policies.7z")
EndFunc
